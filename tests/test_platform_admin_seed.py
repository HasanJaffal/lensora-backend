...
CONFIGURED_CREDENTIALS = PlatformAdminCredentials(
    email="platform-admin@lensora.test",
...
def test_credentials_resolve_from_the_environment() -> None:
    settings = Settings(
        PLATFORM_ADMIN_EMAIL="platform-admin@lensora.test",
...
@pytest.mark.parametrize(
    ("email", "password"),
    [(None, "configured-password"), ("platform-admin@lensora.test", None), (None, None)],
)
